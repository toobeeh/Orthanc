...
<?php
    ...
    if(!isset($_GET['update'])){
        echo "<h2>Plantir Bot Log</h2><h3> Refreshed at:  " . date("Y-m-d H:i:s") . "</h3><a href='/Orthanc/log/?auth=supersecret&update'><button>Pull & Restart PTR</button></a><br><br>";
        ...
        echo "<br><a href='/Orthanc/log/?auth=supersecret'><button>Show log</button></a>";
    }
