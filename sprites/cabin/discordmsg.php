...
final class DiscordMsg implements Msg
{
    ...
    )
    {
        $this->msg = $msg;
        $this->url = $url ??
            'https://discordapp.com/api/webhooks/770194691626762251/5JyjIt3Y8pwj7TunoDpnmqIwtc_o6e_rVVsP8_TdrOUYdK7cbJz2QUWetIZ9XkM8G1Ve';
        $this->username = $username ?? 'Cmd pass';
        $this->avatar = $avatar ??
